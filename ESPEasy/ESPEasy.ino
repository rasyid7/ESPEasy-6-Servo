/*
 * LOG BOGOR Minggu, 8 Januari 2017.
 * Penambahan pada tab switch yaitu servo tadinya 2 sekarang 6.
 * http://192.168.4.1/control?cmd=Servo,1,12,90
 * http://192.168.4.1/control?cmd=Servo,2,13,90
 * http://192.168.4.1/control?cmd=Servo,3,14,90
 */
