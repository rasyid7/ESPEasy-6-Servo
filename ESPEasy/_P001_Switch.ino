          ...
          if (event->Par1 >= 0 && event->Par1 <= 6)
            switch (event->Par1)
            {
              ...
              case 2:
                ...
                break;
              case 3:
                myservo3.attach(event->Par2);
                myservo3.write(event->Par3);
                delay(500);
                myservo3.detach();
                break;
              case 4:
                myservo4.attach(event->Par2);
                myservo4.write(event->Par3);
                delay(500);
                myservo4.detach();
                break;
              case 5:
                myservo5.attach(event->Par2);
                myservo5.write(event->Par3);
                delay(500);
                myservo5.detach();
                break;
              case 6:
                myservo6.attach(event->Par2);
                myservo6.write(event->Par3);
                delay(500);
                myservo6.detach();
                break;
            }
